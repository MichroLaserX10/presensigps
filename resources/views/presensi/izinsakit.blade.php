                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nik') }}" id="nik" class="form-control" placeholder="NIK" 
                                name="nik">
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <tbody>
                        @foreach ($izinsakit as $d )
                            <tr>
                                ...
                                <td>{{ $d->jabatan }}</td>
                                <td>
                                    {{ $d->status == 'i' ? 'Izin' : ($d->status == 's' ? 'Sakit' : ($d->status == 'c' ? 'Cuti' : '-')) }}
                                </td>
                                <td>
                                    @if(!empty($d->doc_skd))
                                        @php
                                            $path = Storage::url('uploads/skd/' . $d->doc_skd);
                                        @endphp
