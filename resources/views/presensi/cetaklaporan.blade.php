...
<body class="A4">
  ...
  <section class="sheet padding-10mm">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td>
                ...
                <span><i>8JV7+P9C, Kenali Asam Atas, Kec. Kota Baru, Kota Jambi, Jambi 36129</i></span>
            </td>
        </tr>
    </table>
    ...
    <table width= "100%" style="margin-top:100px">
        <tr>
            <td colspan="2" style="text-align :right">Jambi, {{ date('d-m-Y') }}</td>
        </tr>
        <tr>
            <td style="text-align: center; vertical-align:bottom" height="100px">
                <u>Abdurrahman, S.Pd.I</u> <br>
                <i><b>Kepala Sekolah</b></i>
            </td>
            <td style="text-align: center; vertical-align:bottom">
                <u>Aulia Nurani, SE</u> <br>
                <i><b>Tata Usaha</b></i>
            </td>
        </tr>
    </table>
